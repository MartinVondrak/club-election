from sqlalchemy import \
    create_engine, MetaData, Table, Column, Integer, String, Boolean, ForeignKey, Text
...
def init_database(db_connection_string: str, debug: bool) -> sessionmaker:
    map_entities_to_tables()
    engine: Engine = create_engine(db_connection_string, echo=debug)
